...
const ForgotPasswordReset = ({authState, authData, onStateChange}) => {

  const classes = useStyles();
  const [renderComponent, setRenderComponent] = React.useState(false)

  React.useEffect(() => {
    setRenderComponent(authState === 'forgotPasswordReset')
  }, [authState])
              ...
              leftSide={
                <div className={classes.formContainer}>
                  <SectionHeader
                      ...
                      subtitle="Enter the code you receive in your email and your new password."
                      titleProps={{
                        variant: 'h3',
                      }}
                  />
